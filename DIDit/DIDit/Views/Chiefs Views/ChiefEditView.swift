...
//    Form {
//        Section {
//            TextField(chief.provenance ?? "provenance (recommended)", text: self.$provenance)
...
//            TextField(chief.startNote ?? "start note (optional)", text: self.$startNote)
//                .textFieldStyle(RoundedBorderTextFieldStyle())
//            DatePicker(selection: self.$chargeDate, in: ...Date(), displayedComponents: .date, label: { Text("Charge date (optional)") })
//            TextField(chief.chargeNote ?? "charge note (optional)", text: self.$chargeNote)
//                .textFieldStyle(RoundedBorderTextFieldStyle())
//            DatePicker(selection: self.$credentialDate, in: ...Date(), displayedComponents: .date, label: { Text("Credential date (optional)") })
//            TextField(chief.credentialNote ?? "credential note (optional)", text: self.$credentialNote)
//                .textFieldStyle(RoundedBorderTextFieldStyle())
//            DatePicker(selection: self.$endDate, in: ...Date(), displayedComponents: .date, label: { Text("End date (optional)") })
//            TextField(chief.endNote ?? "end note (optional)", text: self.$endNote)
//                .textFieldStyle(RoundedBorderTextFieldStyle())
//            TextField(chief.note ?? "instance note (optional)", text: self.$note)
//                .textFieldStyle(RoundedBorderTextFieldStyle())
//        }
//        Section {
