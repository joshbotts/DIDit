...
final class PocomInstance: Identifiable, Codable, ObservableObject {
    var instanceType: PocomInstanceType
    var id: String
...
//    }
    ...
    var poRole: XmlPrincipalOfficerRole?
    var startDate: Date?
    // appointment date
    ...
    var stateOfResidenceOverride: USState?
    ...
    var modificationBy: String?
    var createdWith: DataSource = .app
...
//    }
    ...
    init(poRole: XmlPrincipalOfficerRole, person: PocomPerson, startDate: Date?, startNote: String?, dutyDate: Date?, dutyNote: String?, endDate: Date?, endNote: String?, note: String?, career: Career?, stateOfResidence: USState?) {
    ...
    init(comRole: XmlCOMRole, country: XmlCountry, person: PocomPerson, startDate: Date?, startNote: String?, chargeDate: Date?, chargeNote: String?, credentialDate: Date?, credentialNote: String?, endDate: Date?, endNote: String?, note: String?, career: Career?, stateOfResidence: USState?) {
            let currentDate = Date()
            let didDateFormatter = DateFormatter()
            didDateFormatter.locale = Locale(identifier: "en_US")
            didDateFormatter.dateFormat = "yyyy-MM-dd"
