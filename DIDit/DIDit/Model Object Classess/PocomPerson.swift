...
//    }
    ...
    init(firstName: String, lastName: String, middleName: String?, genName: String?, altName: String?, birthYear: Int?, deathYear: Int?, career: Career?, stateOfResidence: USState?, sex: String?) {
        var id: String {
            var idFirstName = ""
            var idLastName = ""
